...
const Home = (  ) => {
  return (
    <EstruturaPagina>
      ...
      <div className="home-apresentacao">
        <div className="limitar-container">
          ...
          <ul className="lista-servicos">
            <li>
              <img src="dente.png" alt="logo" title="logo"/>
              <p>Pré-avaliação</p>
            </li>
      ...
      <img className="img-aparelho" src="aparelho.png" alt="Imagem do uso de um aparelho" title="Imagem do uso de um aparelho"/>
      ...
      <div className="home-depoimentos">
        ...
        <ul className="lista-depoimentos">
          <li>
            <img className="img-aparelho" src="cliente01.png" alt="Cliente Alberto" title="Cliente Alberto"/>
            <p>Alberto</p>
            <p>Usei aparelho por 2 anos e agora posso sorrir novamente.</p>
          </li>

          <li>
            <img className="img-aparelho" src="cliente02.png" alt="Cliente Eliana" title="Cliente Eliana"/>
            <p>Eliana</p>
            <p>Meus dentes eram espaçados e depois de 1 ano estão no lugar certo.</p>
          </li>

          <li>
            <img className="img-aparelho" src="cliente03.png" alt="Cliente Carla" title="Cliente Carla"/>
            <p>Carla</p>
